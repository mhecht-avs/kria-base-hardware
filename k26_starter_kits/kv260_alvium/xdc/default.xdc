...
#I2C signals --> I2C switch 1--> IAS 1
#I2C signals --> I2C switch 2--> RPi
...
set_property PACKAGE_PIN G11 [get_ports iic0_scl_io]
set_property PACKAGE_PIN F10 [get_ports iic0_sda_io]
set_property IOSTANDARD LVCMOS33 [get_ports iic0_*]
set_property SLEW SLOW [get_ports iic0_*]
set_property DRIVE 4 [get_ports iic0_*]
